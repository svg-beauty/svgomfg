...
export default class MainController {
  constructor() {
    ...
    viewTogglerUi.emitter.on('change', (event) => this._outputUi.set(event.value))
    ...
    domReady.then(() => {
      ...
      const minorActionContainer = container.querySelector('.minor-action-container')
      ...
      this._mainUi = new MainUi(toolbarElement, actionContainer, this._outputUi.container, this._settingsUi.container)

      minorActionContainer.append(bgFillUi.container, this._copyButtonUi.container)
  ...
  _onGlobalCopy(event) {
    ...
    this._toastsUi.show(this._copyButtonUi.copyText() ? 'Copy successful' : 'Nothing to copy', { duration: 2000 })
